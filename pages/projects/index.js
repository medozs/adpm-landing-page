    ...
    <>
      ...
      <Container>
        <div className='space-y-12 my-32 mb-64'>
          <div className="font-bold text-3xl text-center">COMPANY COMITMENT</div>
          <div className='flex justify-between'>
            {serviceListLite.map((item, i) => (
              <div
                key={i}
                onClick={() => setSelected({id: item.id, isSelect: isSelected.isSelect})}
          ...
          <div className='grid grid-cols-3 gap-8'>
            <ProjectCard img="/project-card.jpeg" client="Freeport" scope="Design & Set Up" location="Papua, Indonesia"/>
            <ProjectCard img="/project-card.jpeg" client="Freeport" scope="Design & Set Up" location="Papua, Indonesia"/>
            <ProjectCard img="/project-card.jpeg" client="Freeport" scope="Design & Set Up" location="Papua, Indonesia"/>
            <ProjectCard img="/project-card.jpeg" client="Freeport" scope="Design & Set Up" location="Papua, Indonesia"/>
            <ProjectCard img="/project-card.jpeg" client="Freeport" scope="Design & Set Up" location="Papua, Indonesia"/>
