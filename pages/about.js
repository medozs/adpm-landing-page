...
const About = () => {
  return (
    <>
        <div className="bg-fixed h-[600px] bg-no-repeat bg-cover bg-center bg-[url('/about.jpeg')]">
            <div className='bg-black/40 h-full'>
                <Container className="h-full">
                    <div className='flex justify-end items-center h-full'>
                        <div className='text-5xl text-white font-semibold my-auto'>A Moments of Best Built</div>
                    </div>
                </Container>
            </div>
        </div>
        ...
        <Container>
            <div className='space-y-24 my-32'>
                <div className='text-center max-w-[600px] mx-auto space-y-5'>
                    ...
                    <div className=''>Transparency builds trust. That's why we offer easy access to company documents, fostering informed decisions and ethical business practices.</div>
                </div>
        ...
        <div className='bg-section py-32 text-center font-semibold text-xl'>
            <Container>
                Beauty happens with code not by chance, We employee creative tools, code and solid online branding knowledge to build an elegant solutions for our client.
            </Container>
        </div>
    </>
  )
